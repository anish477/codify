...
class _LeaderboardPageState extends State<LeaderboardPage> {
  ...
  Future<void> _fetchLeaderboard() async {
    try {
      ...
      if (userId != null) {
        Map<String, int> userTotalPoints = await _leaderboardService.getTotalPointsByUserLast7Days();


        List<MapEntry<String, int>> sortedUserPoints = userTotalPoints.entries.toList()
          ..sort((a, b) => b.value.compareTo(a.value));


        List<String> sortedUserIds = sortedUserPoints.map((entry) => entry.key).toList();
